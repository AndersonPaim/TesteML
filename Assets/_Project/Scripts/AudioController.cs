...
public class AudioController : MonoBehaviour
{
    ...
    protected void PlayAudioAtPosition(AudioClip audioClip, AudioMixerGroup audioMixer, float volume, Vector3 pos)
    {
        AudioSource audioSource;
        ...
        obj.SetActive(true); 
        audioSource.volume = volume;
        audioSource.spatialBlend = 1; //3D audio always in this function
